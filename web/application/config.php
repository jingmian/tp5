...
return [
    ...
    'root_namespace'         => [],
    // 扩展函数文件
    'extra_file_list'        => [THINK_PATH . 'helper' . EXT, EXTEND_PATH . 'helper' . EXT],
    // 默认输出类型
    ...
    // +----------------------------------------------------------------------
        ...
        "static_path" => [
            ...
            "home"  => [
                "__HOME__MR__" => "/default/home",
                "__HOME__"     => "/" . MS_TEMPLATE . "/home",
                "__JS__"       => "/" . MS_TEMPLATE . "/home/js",
                "__CSS__"      => "/" . MS_TEMPLATE . "/home/css",
                "__IMG__"      => "/" . MS_TEMPLATE . "/home/img",
                "__EXT__"      => "/extend",
                "__UP__"       => APP_UPLOAD,
            ],
            "wap"   => [
                "__WAP__MR__" => "/default/wap",
                "__WAP__"     => "/" . MS_TEMPLATE . "/wap",
                "__JS__"      => "/" . MS_TEMPLATE . "/wap/js",
                "__CSS__"     => "/" . MS_TEMPLATE . "/wap/css",
                "__IMG__"     => "/" . MS_TEMPLATE . "/wap/img",
                "__EXT__"     => "/extend",
                "__UP__"      => APP_UPLOAD,
            ],
            "api"   => [
                "__API__MR__" => "/default/api",
                "__API__"     => "/" . MS_TEMPLATE . "/api",
                "__JS__"      => "/" . MS_TEMPLATE . "/api/js",
                "__CSS__"     => "/" . MS_TEMPLATE . "/api/css",
                "__IMG__"     => "/" . MS_TEMPLATE . "/api/img",
                "__EXT__"     => "/extend",
                "__UP__"      => APP_UPLOAD,
            ],
